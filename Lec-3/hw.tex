...
\begin{homeworkProblem}[Problem 3]
  ...
  \Answer 
  \begin{itemize}
  \item[a.] After a third pulse, the output will be 1 and 1. After a fourth pulse, the output will be 0 and 0. 

  \item[b.] On the $2^{nd}, \,4^{th}, \,6^{th}, \dots$ pulses of the clock, a 1 will be sent on output B. On the $3^{rd}, \, 7^{th}, \, 11^{th}, \dots$ pulses of the clock, a 1 will be sent on output C. On the $4^{th}$ pulse of the clock a 1 is sent on output B. 
...
\begin{homeworkProblem}[Problem 6]
  ...
  \Answer If each cell's address can be represented by 2 hexadecimal digits, 256 cells can be in a computer's main memory. For 4 hexadecimal digits used, the answer is 65536. 
\end{homeworkProblem}
...
\begin{homeworkProblem}[Problem 9]
  ...
  \Answer 
  \begin{itemize}
  \item[a.] $\texttt{(101000001010)}_2 = \texttt{0xA0A}$
  \item[b.] $\texttt{(110001111011)}_2 = \texttt{0xC7B}$
  \item[c.] $\texttt{(000010111110)}_2 = \texttt{0xBE}$
  \end{itemize}
...
\begin{homeworkProblem}[Problem 15]
  ...
  \Answer 1400000 bytes will be needed for ASCII. 2800000 bytes will be needed for Unicode. 
...
b. What is the relationship between a pattern representing a value stored in two’s complement notation and the pattern representing the same value stored in excess notation when both systems use the same bit pattern length?
  ...
  \Answer 
  a. It must be 11 or -5. 
  
  b. They are different in high-order end and are the same at the other positions.
...
\begin{homeworkProblem}[Problem 52]
  ...
  \Answer In \texttt{11011, 00000, 10001}. 
